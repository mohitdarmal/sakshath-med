...
export default function FindDoctors() {
  ...
  let arr = [
    {
      img: require('../../assets/images/e5df380532ad97807c4b2e414a458cc2.png').default,
    ...
    {
      img: require('../../assets/images/1da3446c1aca11295e4ea403b52fe8bc.png').default,
    ...
    {
      img: require('../../assets/images/6147081e5f5d09a285ee9904bfdd26bf96998d47.jpg').default,
    ...
    {
      img: require('../../assets/images/1248187c88fa20fb11116f02779b39d4.png').default,
    ...
    {
      img: require('../../assets/images/eb77fb7edc101645ee455f878299f68f.png').default,
      ...
      <div className={styles.secondPage}>
        <div className={styles.secondPageSubject}>
          <div className={`${styles.secondPageFlexbox} ${styles.content}`}>
            ...
            <div className={styles.flex2}>
              <div>
                <div>
                  <img
                    src={require('../../assets/images/security_1.4f45ac92aba979dac915f.png').default}
                    alt="img"
                  />
                </div>
              </div>
          ...
          <div className={styles.iconBox}>
            <div>
              <img
                src={require('../../assets/images/security_2.654a7085bfa74c726f26b (1).png').default}
                alt="img"
              />
              <div>
                <p>256-bit</p>
            ...
            <div>
              <img
                 src={require('../../assets/images/security_3.a73921ca6e980ed186518.png').default}
                alt="img"
              />
              <div>
                <p>ISO 27001</p>
            ...
            <div>
              <img
                src={require('../../assets/images/security_4.216e25d35038f0e7f6d8a.png').default}
                alt="img"
              />
              <div>
                <p>HIPAA</p>
            ...
            <div>
              <img
               src={require('../../assets/images/security_5.cf6e04c57178071a67c21.png').default}
                alt="img"
              />
              <div>
                <p>DSCI</p>
              ...
              <div>
                <div>
                  <video autoPlay loop muted>
                    <source
                      type="video/webm"
                      src={require('../../assets/images/appointment.700ce682eaec91bf93b6574cb8f09cd0.webm').default}
                    />
                  </video>
                </div>
              </div>
            ...
            <div className={styles.flex2}>
              <div>
                <div>
                  <video autoPlay loop muted>
                    <source 
                      src={require('../../assets/images/consult.099446892618434cc8a038d7844c4380.webm').default}
                    />
                  </video>
                </div>
              </div>
          ...
          <div className={`${styles.secondPageFlexbox} ${styles.content}`}>
            ...
            <div className={styles.flex2}>
              <div>
                <div>
                  <img
                    src={require('../../assets/images/order.c84fc07b0be8a7e8d4db432eb4e606a2.svg').default}
                    alt="img"
                  />
                </div>
              </div>
          ...
          <div className={`${styles.secondPageFlexbox} ${styles.content}`}>
            <div className={styles.flex2}>
              <div>
                <div>
                  <img
                    src={require('../../assets/images/record.bfc5241f9b15340a32c98eb360d1005a.svg').default}
                    alt="img"
                  />
                </div>
              </div>
          ...
          <div className={`${styles.secondPageFlexbox} ${styles.content}`}>
            <div className={styles.flex1}>
              <div>
                ...
                <div className={styles.tickBox}>
                  <div>
                    <i className="ion-checkmark-round"></i>
                    <span>Get seen by 25M+ patients on Sakshath-technologies.com</span>
                  </div>
                </div>
                <div className={styles.tickBox}>
                  <div>
            ...
            <div className={`${styles.flex2} ${styles.flex4}`}>
              <div>
                <div>
                  <img
                    src={require('../../assets/images/dashboard.jpg').default}
                    alt="img"
                  />
                </div>
              </div>
          ...
          <div className={`${styles.secondPageFlexbox} ${styles.content}`}>
            <div className={styles.flex2}>
              <div>
                <div>
                  <img
                   src={require('../../assets/images/m-dashboard.jpg').default}
                    alt="img"
                  />
                </div>
              </div>
            ...
            <div className={styles.flex1}>
              <div>
                <div className={styles.flex1Heading}>
                  <h2>Download the Sakshath app</h2>
                </div>
                <div className={styles.tickBox}>
                  <div>
                    <i className="ion-checkmark-round"></i>
                ...
                <div className={`${styles.appDownloadIcons}`}>
                  <a href="#">
                    <img
                      src={require('../../assets/images/google_badge.bfeb9607baa4c7c0b68.png').default}
                      alt="Get it on Google Play"
                    />
                  </a>
                  <a href="https://app.appsflyer.com/id953772015?pid=web&amp;amp;c=homepage">
                    <img
                      src={require('../../assets/images/appstore_badge.adc5473a4cad8e6b9.png').default}
