							...
							>
								<div className='subcard2'>
									<div style={{ width: '280px', height: '200px' }}>
										<span>
											<img
												src={require('../../../assets/images/5fd27b74d9477cb633445cf3f105078bbc479910.jpg').default}
												alt=''
												style={{
													bordeRadius: '4px',
							...
							>
								<div className='subcard2'>
									<div style={{ width: '280px', height: '200px' }}>
										<span>
											<img
												src={require('../../../assets/images/bade52edc7fb158bf627216bf96c2b881a97f30c.jpg').default}
												alt=''
												style={{
													bordeRadius: '4px',
													verticalAlign: 'bottom',
