	...
	const offers = [
		{
			...
			bg: "green",
			desc: 'Download App',
			img: require('../../assets/images/offer-app-v1.png').default,
		},
		{
			...
			bg: "pink",
			desc: 'Get Membership',
			img: require('../../assets/images/offer-plus-plan-v2.png').default,
		},
		{
			...
			bg: "orange",
			desc: 'Consult Now',
			img: require('../../assets/images/offer-specialist-v1.png').default,
		}
	];
