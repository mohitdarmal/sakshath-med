	...
	const specialization = [
		{
			name: 'Gynaecology',
			price: 349,
			img: require('../../assets/images/top-speciality-gynaecologist.svg').default,
		},
		{
			name: 'Sexology',
			price: 400,
			img: require('../../assets/images/top-speciality-sexology (1).svg').default,
		},
		{
			name: 'General physician',
			price: 299,
			img: require('../../assets/images/top-speciality-gp.svg').default,
		},
		{
			name: 'Dermatology',
			price: 400,
			img: require('../../assets/images/top-speciality-dermatologist.svg').default,
		},
		{
			name: 'Psychiatry',
			price: 349,
			img: require('../../assets/images/top-speciality-psychiatric.svg').default,
		},
		{
			name: 'Stomach and digestion',
			price: 400,
			img: require('../../assets/images/top-speciality-stomach.svg').default,
		},
		{
			name: 'Pediatrics',
			price: 349,
			img: require('../../assets/images/top-speciality-pediatric.svg').default,
		},
		{ name: 'Urology', price: 400, img: require('../../assets/images/top-speciality-kidney.svg').default, }
	];
