			...
			<div className={style.pink}>
						...
						<article className={style.cardstrip}>
							<div className={style.docimg}>
								<span className={style.eachimg} style={{ zIndex: 4 }}>
									<img
										className={style.doc}
										src={require('../../assets/images/dr-milind-kulkarni-1484306142-5878b6de533af.jpg').default}
										alt=''
									/>
								</span>
								<span className={style.eachimg} style={{ zIndex: 3 }}>
									<img
										className={style.doc}
										src={require('../../assets/images/dr-sidharth-verma-1482421214-585bf3deb1bf3.jpg').default}
										alt=''
									/>
								</span>
								<span className={style.eachimg} style={{ zIndex: 2 }}>
									<img
										className={style.doc}
										src={require('../../assets/images/dr-pankaj-kumar-1475218773-57ee0d55b4559.jpg').default}
										alt=''
									/>
								</span>
								<span
              ...
              Consult now
					...
					<img
						...
						id='pinkbanner'
						src={require('../../assets/images/doc.png').default}
						alt=''
					/>
