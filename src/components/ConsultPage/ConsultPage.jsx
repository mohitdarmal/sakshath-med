			...
			<div>
					...
					<div className={styles.flex2}>
						<div className={styles.flex12}>
							...
							<div className={styles.posterDiv}>
								<div className={styles.posterDivImgBox}>
									<img
										src={require('../../assets/images/smile-care-orthodontic-center-and-multispeciality-dental-clinic-bangalore-5de10d366e186.jpg').default}
										alt='img'
									/>
								</div>
								<div className={styles.posterDetail}>
                ...
                <input type="text" />
								...
								<div className={styles.termsDiv}>
									By booking this appointment, you agree to Sakshath's{' '}
